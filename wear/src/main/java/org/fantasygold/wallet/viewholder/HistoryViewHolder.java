package org.fantasygold.wallet.viewholder;
...
public class HistoryViewHolder extends WearableRecyclerView.ViewHolder {
    ...
    public void bind(History history) {
        ...
        if(history.getChangeInBalance() != null) {
            mTextViewValue.setText(String.format("%s FGC",history.getChangeInBalance().toString()));
        } else {
            mTextViewValue.setText(String.format("%s FGC","null"));
        }
    }
}
