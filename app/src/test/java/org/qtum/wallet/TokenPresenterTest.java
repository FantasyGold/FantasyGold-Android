...
import org.fantasygold.wallet.ui.fragment.token_fragment.TokenInteractor;
import org.fantasygold.wallet.ui.fragment.token_fragment.TokenPresenterImpl;
import org.fantasygold.wallet.ui.fragment.token_fragment.TokenView;
...
public class TokenPresenterTest {
    ...
    public void initialize_TokenWithDecimals() {
        ...
        verify(view, times(1)).setFantasyGoldAddress(interactor.getCurrentAddress());
