package org.fantasygold.wallet.dataprovider.services.update_service;
...
import org.fantasygold.wallet.dataprovider.firebase.FirebaseSharedPreferences;
import org.fantasygold.wallet.dataprovider.firebase.listeners.FireBaseTokenRefreshListener;
...
import org.fantasygold.wallet.utils.BoughtContractBuilder;

import org.fantasygold.wallet.R;
import org.fantasygold.wallet.dataprovider.services.update_service.listeners.ContractPurchaseListener;
import org.fantasygold.wallet.dataprovider.services.update_service.listeners.TokenListener;
import org.fantasygold.wallet.dataprovider.services.update_service.listeners.TransactionListener;
...
import org.fantasygold.wallet.utils.CurrentNetParams;
import org.fantasygold.wallet.utils.DateCalculator;
import org.fantasygold.wallet.utils.FantasyGoldIntent;
...
import static org.fantasygold.wallet.WearListCallListenerService.ADDRESS;
import static org.fantasygold.wallet.WearListCallListenerService.BALANCE;
import static org.fantasygold.wallet.WearListCallListenerService.CURR_TIME_MILLS;
import static org.fantasygold.wallet.WearListCallListenerService.ITEMS;
import static org.fantasygold.wallet.WearListCallListenerService.UNC_BALANCE;
import static org.fantasygold.wallet.utils.StringUtils.convertBalanceToString;
...
public class UpdateService extends Service implements GoogleApiClient.ConnectionCallbacks {
    ...
    public void onCreate() {
        ...
        final FantasyGoldSharedPreference fantasygoldSharedPreference = FantasyGoldSharedPreference.getInstance();

        String balanceString = fantasygoldSharedPreference.getBalanceString(getApplicationContext());
        final String unconfirmedBalanceString = fantasygoldSharedPreference.getUnconfirmedBalanceString(getApplicationContext());
        Long lastUpdatedBalanceTime = fantasygoldSharedPreference.getLastUpdatedBalanceTime(getApplicationContext());
            ...
            public void call(Object... args) {
                try {
                    ...
                    try {
                        ...
                        fantasygoldSharedPreference.setBalanceString(getApplicationContext(), balance.toString());
                        fantasygoldSharedPreference.setUnconfirmedBalanceString(getApplicationContext(), unconfirmedBalance.toString());
                        fantasygoldSharedPreference.setLastUpdatedBalanceTime(getApplicationContext(), mLastUpdatedBalanceTime);
    ...
    private void onBalanceChange() {
        FantasyGoldService.newInstance().getHistoryListForSeveralAddresses(addresses, 10, 0)
    ...
    private void sendNotification(String Ticker, String Title, String Text, Uri sound) {
        ...
        notificationIntent.setAction(FantasyGoldIntent.OPEN_FROM_NOTIFICATION);
