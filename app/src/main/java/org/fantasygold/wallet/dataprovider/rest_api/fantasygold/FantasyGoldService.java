...
public class FantasyGoldService {

    private static FantasyGoldService sFantasyGoldService;
    private FantasyGoldRestService mServiceApi;

    public static FantasyGoldService newInstance() {
        if (sFantasyGoldService == null) {
            sFantasyGoldService = new FantasyGoldService();
        }
        return sFantasyGoldService;
    }

    private FantasyGoldService() {
        try {
            ...
            mServiceApi = retrofit.create(FantasyGoldRestService.class);
    ...
    public Observable<TokenHistoryResponse> getTokenHistoryList(String fgc20ContractAddress, int limit, int offset, List<String> addresses){
        return mServiceApi.getTokenHistoryList(fgc20ContractAddress, limit, offset, addresses);
    }
