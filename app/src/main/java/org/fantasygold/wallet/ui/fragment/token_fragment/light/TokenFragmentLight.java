package org.fantasygold.wallet.ui.fragment.token_fragment.light;
...
import org.fantasygold.wallet.ui.fragment.token_fragment.dark.TokenHistoryAdapterDark;
...
public class TokenFragmentLight extends TokenFragment {
    ...
    private final int LAYOUT = org.fantasygold.wallet.R.layout.lyt_token_fragment_light;

    @BindView(org.fantasygold.wallet.R.id.wave_view)
    WaveView waveView;
    private WaveHelper mWaveHelper;

    @BindView(org.fantasygold.wallet.R.id.bt_share)
    ImageButton mShareBtn;

    @BindView(org.fantasygold.wallet.R.id.iv_choose_address)
    ImageView mIvChooseAddress;

    @BindView(org.fantasygold.wallet.R.id.tv_token_name)
