...
import org.fantasygold.wallet.model.gson.history.HistoryPayType;
...
import org.fantasygold.wallet.ui.fragment.transaction_fragment.HistoryType;
import org.fantasygold.wallet.ui.fragment.transaction_fragment.TransactionFragment;
...
public class TokenPresenterImpl extends BaseFragmentPresenterImpl implements TokenPresenter {
    ...
    private void setFantasyGoldAddress() {
        getView().setFantasyGoldAddress(getInteractor().getCurrentAddress());
    }
