...
import org.fantasygold.wallet.ui.fragment.about_fragment.AboutFragment;
...
import static org.fantasygold.wallet.ui.fragment.pin_fragment.PinAction.AUTHENTICATION_FOR_PASSPHRASE;
import static org.fantasygold.wallet.ui.fragment.pin_fragment.PinAction.CHANGING;
...
public abstract class ProfileFragment extends BaseNavFragment implements ProfileView, OnSettingClickListener {
    ...
    @BindView(org.fantasygold.wallet.R.id.pref_list)
    ...
    public void onSettingClick(int key) {
        ...
        switch (key) {
            case org.fantasygold.wallet.R.string.language:
                fragment = LanguageFragment.newInstance(getContext());
                break;
            case org.fantasygold.wallet.R.string.change_pin:
                fragment = PinFragment.newInstance(CHANGING, getContext());
                break;
            case org.fantasygold.wallet.R.string.wallet_backup:
                fragment = PinFragment.newInstance(AUTHENTICATION_FOR_PASSPHRASE, getContext());
                break;
            case org.fantasygold.wallet.R.string.smart_contracts:
                fragment = SmartContractsFragment.newInstance(getContext());
                break;
            case org.fantasygold.wallet.R.string.subscribe_tokens:
                fragment = SubscribeTokensFragment.newInstance(getContext());
                break;
            case org.fantasygold.wallet.R.string.about:
                fragment = AboutFragment.newInstance(getContext());
                break;
            case org.fantasygold.wallet.R.string.log_out:
                ...
                break;
            case org.fantasygold.wallet.R.string.switch_theme:
    ...
    public void onSwitchChange(int key, boolean isChecked) {
        switch (key) {
            case org.fantasygold.wallet.R.string.touch_id:
