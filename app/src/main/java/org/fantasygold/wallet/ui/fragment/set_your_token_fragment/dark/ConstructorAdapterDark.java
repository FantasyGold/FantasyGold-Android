...
public class ConstructorAdapterDark extends ConstructorAdapter {
    ...
    public InputViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new InputViewHolderDark(LayoutInflater.from(parent.getContext()).inflate(org.fantasygold.wallet.R.layout.lyt_constructor_input, parent, false), listener);
    }
