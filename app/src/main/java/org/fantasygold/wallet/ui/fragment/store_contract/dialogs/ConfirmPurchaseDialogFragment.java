package org.fantasygold.wallet.ui.fragment.store_contract.dialogs;
...
public class ConfirmPurchaseDialogFragment extends AppCompatDialogFragment {
    ...
    @BindView(org.fantasygold.wallet.R.id.contract_name)
    FontTextView tvContractName;

    @BindView(org.fantasygold.wallet.R.id.contract_type)
    FontTextView tvContractType;

    @BindView(org.fantasygold.wallet.R.id.price)
    FontTextView tvPrice;

    @BindView(org.fantasygold.wallet.R.id.miner_address)
    FontTextView tvMinerAddress;

    @OnClick(org.fantasygold.wallet.R.id.btn_cancel)
    public void onCancelClick() {
        dismiss();
    }

    @OnClick(org.fantasygold.wallet.R.id.btn_confirm)
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate((ThemeUtils.getCurrentTheme(getContext()).equals(ThemeUtils.THEME_DARK) ? org.fantasygold.wallet.R.layout.lyt_confirm_purchase : org.fantasygold.wallet.R.layout.lyt_confirm_purchase_light), container, false);
