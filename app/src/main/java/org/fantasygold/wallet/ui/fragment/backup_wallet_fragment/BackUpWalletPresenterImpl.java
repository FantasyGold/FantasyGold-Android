...
import org.fantasygold.wallet.ui.fragment.confirm_passphrase_fragment.ConfirmPassphraseFragment;
...
//                            FantasyGoldSharedPreference.getInstance().setKeyGeneratedInstance(getView().getContext(), true);
