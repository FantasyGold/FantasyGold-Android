package org.fantasygold.wallet.ui.fragment.wallet_fragment.dark;
...
public class TransactionAdapterDark extends TransactionAdapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_TRANSACTION) {
            ...
            View view = layoutInflater.inflate(org.fantasygold.wallet.R.layout.item_transaction, parent, false);
