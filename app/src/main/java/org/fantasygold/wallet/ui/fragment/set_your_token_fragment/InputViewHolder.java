...
import org.fantasygold.wallet.utils.EditTextValidated;
...
public abstract class InputViewHolder extends RecyclerView.ViewHolder implements EditTextValidated.EditTextValidateListener {
    ...
    @BindView(org.fantasygold.wallet.R.id.til_param)
    protected
    TextInputLayout tilParam;

    @BindView(org.fantasygold.wallet.R.id.et_param)
    protected
    EditTextValidated etParam;

    @BindView(org.fantasygold.wallet.R.id.checkbox)
