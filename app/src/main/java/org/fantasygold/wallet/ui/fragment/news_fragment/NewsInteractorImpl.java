...
import org.fantasygold.wallet.dataprovider.rest_api.medium.MediumService;
...
public class NewsInteractorImpl implements NewsInteractor {
    ...
    private final String MEDIUM_FGC_CHANEL = "@fantasygold";
    ...
    public Observable<RssFeed> getMediumRssFeed() {
        return MediumService.getInstance().getRssFeed(MEDIUM_FGC_CHANEL);
    }
