package org.fantasygold.wallet.ui.fragment.fantasygold_cash_management_fragment.light;
...
import org.fantasygold.wallet.ui.fragment.fantasygold_cash_management_fragment.AddressesWithBalanceAdapter;
    ...
    protected void showTransferDialogFragment(final AddressWithBalance keyWithBalanceTo, List<AddressWithBalance> keyWithBalanceList) {
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                tvBalanceFrom.setText(String.format("%s FGC", balance.toString()));
            }
