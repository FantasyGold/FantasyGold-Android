...
import org.fantasygold.wallet.ui.fragment.import_wallet_fragment.ImportWalletFragment;
    ...
    public void OnClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.bt_import_wallet:
                ...
                break;
            case R.id.bt_login:
                if (FantasyGoldSharedPreference.getInstance().getKeyGeneratedInstance(getContext())) {
