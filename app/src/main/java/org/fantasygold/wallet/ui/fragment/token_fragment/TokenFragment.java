...
import org.fantasygold.wallet.ui.fragment.wallet_fragment.HistoryCountChangeListener;
...
import org.fantasygold.wallet.ui.fragment.token_fragment.dialogs.ShareDialogFragment;
import org.fantasygold.wallet.utils.ClipboardUtils;
...
public abstract class TokenFragment extends BaseFragment implements TokenView, TokenHistoryClickListener {
    ...
    private static final String fantasygoldAddressKey = "fantasygoldAddressKey";
    ...
    @Override
    public void setFantasyGoldAddress(String address) {
        if (!TextUtils.isEmpty(address)) {
