package org.fantasygold.wallet.ui.fragment.receive_fragment;
...
import org.fantasygold.wallet.ui.activity.main_activity.FragmentKeyboardEventListener;
...
public abstract class ReceiveFragment extends BaseFragment implements ReceiveView, FragmentKeyboardEventListener {
    ...
    private void chooseShareMethod() {
        if (getQrCode() != null) {
            String pathofBmp = MediaStore.Images.Media.insertImage(getContext().getContentResolver(), getQrCode(), "FGC QRCode", "Share");
            ...
            getMainActivity().startActivity(Intent.createChooser(intentShareFile, "FantasyGold QR-Code"));
        }
    }
