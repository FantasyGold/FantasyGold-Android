package org.fantasygold.wallet.ui.fragment.confirm_passphrase_fragment;
...
public class ConfirmPassphraseInteractorImpl implements ConfirmPassphraseInteractor {
    ...
    public void setKeyGeneratedInstance(boolean isKeyGenerated) {
        FantasyGoldSharedPreference.getInstance().setKeyGeneratedInstance(mContext.get(), isKeyGenerated);
    }
}
