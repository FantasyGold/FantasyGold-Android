...
public class NewsPresenterImpl extends BaseFragmentPresenterImpl implements NewsPresenter {
    ...
    public void onRefresh() {
        if (mNetworkConnectedFlag) {
            ...
            getView().setAlertDialog(org.fantasygold.wallet.R.string.no_internet_connection,
                    org.fantasygold.wallet.R.string.please_check_your_network_settings,
                    org.fantasygold.wallet.R.string.ok,
