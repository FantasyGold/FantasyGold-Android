...
import org.fantasygold.wallet.utils.SearchBar;
import org.fantasygold.wallet.utils.SearchBarListener;
...
public abstract class SubscribeTokensFragment extends BaseFragment implements SubscribeTokensView, SearchBarListener {
    ...
    @BindView(org.fantasygold.wallet.R.id.recycler_view)
    protected
    RecyclerView mRecyclerView;

    @BindView(org.fantasygold.wallet.R.id.tv_currency_title)
    TextView mTextViewCurrencyTitle;

    @BindView(org.fantasygold.wallet.R.id.search_bar)
    SearchBar searchBar;
    ...
    public void initializeViews() {
        ...
        mTextViewCurrencyTitle.setText(org.fantasygold.wallet.R.string.chose_to_subscribe);
    ...
    class TokenHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(org.fantasygold.wallet.R.id.tv_single_string)
        TextView mTextViewCurrency;
        @BindView(org.fantasygold.wallet.R.id.iv_check_indicator_blue)
        ImageView mImageViewCheckIndicator;
        @BindView(org.fantasygold.wallet.R.id.ll_single_item)
