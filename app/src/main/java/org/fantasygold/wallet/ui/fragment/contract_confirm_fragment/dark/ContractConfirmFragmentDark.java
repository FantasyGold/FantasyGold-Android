...
import org.fantasygold.wallet.ui.fragment.contract_confirm_fragment.ContractConfirmFragment;
...
public class ContractConfirmFragmentDark extends ContractConfirmFragment {
    ...
    public final int LAYOUT = org.fantasygold.wallet.R.layout.lyt_contract_confirm;

    @OnClick(org.fantasygold.wallet.R.id.cancel)
