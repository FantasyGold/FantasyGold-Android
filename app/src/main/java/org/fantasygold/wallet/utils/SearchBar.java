...
public class SearchBar extends RelativeLayout implements View.OnClickListener{
    ...
    private void build(){
        setClickable(true);
        placeholderIcon = (ImageView) findViewById(org.fantasygold.wallet.R.id.icon);
        placeholderText = (TextView) findViewById(org.fantasygold.wallet.R.id.text);
        input = (EditText) findViewById(org.fantasygold.wallet.R.id.input);
        placeholder = (LinearLayout) findViewById(org.fantasygold.wallet.R.id.placeholder);
        cancel = (Button) findViewById(org.fantasygold.wallet.R.id.cancel);

        clearSearch = (ImageView) findViewById(org.fantasygold.wallet.R.id.bt_clear_search);
