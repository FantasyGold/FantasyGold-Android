...
import org.fantasygold.wallet.utils.sha3.Keccak;
import org.fantasygold.wallet.utils.sha3.Parameters;
...
public class ContractBuilder {
    ...
    public String createTransactionHash(Script script, List<UnspentOutput> unspentOutputs, int gasLimit, int gasPrice, BigDecimal feePerKb, String feeString, String sendToContractString,Context context, String passphrase) {
        ...
        try {
            ...
            throw new RuntimeException(mContext.getString(org.fantasygold.wallet.R.string.invalid_fantasygold_address));
        }
        ...
        if (minimumFee.doubleValue() > fee.doubleValue()) {
            throw new RuntimeException(context.getString(R.string.insufficient_fee_lease_use_minimum_of) + " " + minimumFee.toString() + " FGC");
        }
    ...
    public static boolean checkForValidityFGC20(String abiCode) {
