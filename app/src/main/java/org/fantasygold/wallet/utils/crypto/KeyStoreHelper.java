package org.fantasygold.wallet.utils.crypto;
...
public class KeyStoreHelper {
    ...
    public final static String FGC_PIN_ALIAS = "fantasygold_alias";

    public static String getSeed(Context context, @NonNull String pin) {
        String cryptoSaltPassphrase = FantasyGoldSharedPreference.getInstance().getSeed(context);
